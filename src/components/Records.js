...
const Records = ({ fieldsSelected, customFields, data, setData, tags, handleDataUpdate, setTags, customizeGridBar,
  tagsBar}) => {
  ...
  return (
    <>
      ...
      <div className={`records ${(customizeGridBar || tagsBar) ? 'mobile-overflow' : ''}`}>
